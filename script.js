//89% of storage used … If you run out of space, you can't save to Drive or use Gmail. Get 30 GB of storage for ₹59.00 ₹0 for 1 month.
const movies = [
  {
    id: 533535,
...
triller.addEventListener('click',()=>{
    let newMovie=movies.filter((movie)=>movie.category==='Triller');
    showData(newMovie);
})
